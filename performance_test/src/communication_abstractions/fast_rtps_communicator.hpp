...
public:
  ...
  : m_resources(ResourceManager::get().fastdds_resources(eprosima::fastdds::dds::TypeSupport(new TopicType()))),
...
public:
  ...
  std::vector<ReceivedMsgStats> take() override
  {
    ...
    while (eprosima::fastrtps::types::ReturnCode_t::RETCODE_OK == m_datareader->take(data_seq, info_seq, 1)) {
